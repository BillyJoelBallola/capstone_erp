        ...
        <>
            <div className="pt-14 px-4 grid gap-3 py-3 border border-t-0 border-b-gray-200 bg-white">
                <div className='flex items-center justify-between'>
                    ...
                    <div className={`flex gap-4 items-center ${formattedName === "inventory" ? 'w-1/3' : '' }`}>
                        {
                        ...
                        }
                        {
                            ...
                            <div className='flex gap-4'>
                                <div className='flex items-center gap-2 bg-gray-100 pl-2 rounded-lg'>
                        ...
                        }
                        {
                            ...
                            <div className='flex gap-4'>
                                ...
                                <input type="month" onChange={(e) => setProductionFilter(prev => ({...prev, monthYear: e.target.value}))}/>
                            </div>
                        }
                        {
                            formattedName === "purchase" &&
                            <div className='flex gap-4'>
                                <select onChange={(e) => setPurchaseFilter(prev => ({...prev, supplier: e.target.value}))}>
                                ...
                                <input type="month" onChange={(e) => setPurchaseFilter(prev => ({...prev, monthYear: e.target.value}))}/>
                            </div>
                        }
